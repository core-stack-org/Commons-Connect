...
const SurfaceWaterBodies = () => {
    ...
    const toggleFormsUrl = () =>{
        ...
        if(coordinatesToUse){
            ...
            MainStore.setFormUrl(getOdkUrlForScreen(MainStore.currentScreen, MainStore.currentStep, coordinatesToUse, "", "", MainStore.blockName, MainStore.currentPlan.plan_id, MainStore.currentPlan.plan, "", MainStore.isResourceOpen, gpsCoords))
            MainStore.setIsOpen(true)
        }
    }
