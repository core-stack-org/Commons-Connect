...
const InfoBox = () => {
  ...
  const isAgrohorticultureMaskActive = useMainStore(
    (state) => state.isAgrohorticultureMaskActive,
  );
          ...
          <>
            {layerClicked === "CLARTLayer" ? (
              ...
              <>
                ...
                <div className="mt-2 space-y-2">
                  ...
                  <div className="flex items-center">
                    <div
                      className="w-6 h-6 rounded mr-3"
                      style={{ backgroundColor: "#a50026", opacity: 0.7 }}
                    ></div>
                  ...
                  <div className="flex items-center">
                    <div
                      className="w-6 h-6 rounded mr-3"
                      style={{ backgroundColor: "#e0f3f8", opacity: 0.7 }}
                    ></div>
                  ...
                  <div className="flex items-center">
                    <div
                      className="w-6 h-6 rounded mr-3"
                      style={{ backgroundColor: "#fffc00", opacity: 0.7 }}
                    ></div>
                  ...
                  <div className="flex items-center">
                    <div
                      className="w-6 h-6 rounded mr-3"
                      style={{ backgroundColor: "#feb24c", opacity: 0.7 }}
                    ></div>
                  ...
                  <div className="flex items-center">
                    <div
                      className="w-6 h-6 rounded mr-3"
                      style={{ backgroundColor: "#f46d43", opacity: 0.7 }}
                    ></div>
                    <span>Flat tops</span>
                  </div>
                  <div className="flex items-center">
              ...
              <>
                ...
                <p className="text-gray-700 text-sm mb-3">
                  The natural depressions map shows areas which are at lower
                  elevations than surrounding areas and hence sinks for surface
                  water.
                </p>
                <div className="mt-2 space-y-2">
                  <div className="flex items-center">
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center pointer-events-none">
      ...
      <div
        ...
        style={{
          animation:
            "modalExpand 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards",
        }}
      >
        {/* Header */}
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-green-700 mt-1">
                            Your KML file has been processed successfully.
                          </p>
                        </div>
                      </div>
                      <button
            ...
            <div className="text-gray-800 text-sm space-y-6">
              ...
              <div>
                ...
                <ol className="space-y-3">
                  {[t("info_main_1"), t("info_main_2"), t("info_main_3")].map(
                    (item, index) => (
